...
import { UseFileUploadProps, UseFileUploadReturn, FileUploadOptions } from './types';
...
export const useFileUpload = ({
  ...
  const compressImage = useCallback((file: File, options: FileUploadOptions): Promise<File> => {
